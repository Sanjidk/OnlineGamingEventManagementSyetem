        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/accordions.html">Upcoming Event</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">Event Register</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/badges.html">Confirmed Register</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/breadcrumbs.html">Finished Event</a></li>
              </ul>
              </div>
          </li>
          <li class="nav-item">
