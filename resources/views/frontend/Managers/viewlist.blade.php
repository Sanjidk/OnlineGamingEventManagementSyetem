        ...
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-5">
                <button class="btn btn-outline-primary">
                    <h2 style="color: #01156b" class="masthead-heading">PARTICIPATOR PAYMENT LIST</h2>
                    ...
                    <table class="table">
                        ...
                        @foreach($payment as $key=>$data )
                            <tr>
                                ...
                                <td>{{$data->eventPayment->eventName}}</td>
                                <td>{{$data->userPayment->name}}</td>
                                <td>{{$data->phone}}</td>
